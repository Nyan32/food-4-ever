    ...
    <div class="d-flex" style="min-height:100vh">
        <div class="d-none d-lg-block bg-yellow-1 kategori-menu-side">
            <div class="d-flex flex-column position-sticky top-0 p-2" style="min-height:100vh;max-height:100vh;">
                ...
                <div class="d-flex flex-column justify-content-start flex-grow-1 px-1" style=" overflow-y:auto;"
                    id="kategoriContainerFull">
                    <ul>
                        <?php
        ...
        <div class="flex-grow-1 d-flex flex-column" style="min-height:100vh">
            <div id="titleKategoriScroll" class="d-flex justify-content-between align-items-center p-2"
            ...
            <div class="d-flex flex-column flex-grow-1" style="min-height: 90vh;">
                <div id="menuContainer" class="flex-grow-1 p-1 d-flex flex-wrap" style="align-content: flex-start;">
                </div>

                <div class="d-flex flex-column position-sticky bottom-0 w-100" style="z-index:30;max-width:100vw;">
                    <div id="kategoriMinList" class="bg-yellow-1 position-relative bottom-0 d-none overflow-hidden"
                        style="z-index:-30; border-top:solid black 2px;">
                        <div>
                            <ul>
                                <?php
                                for ($i = 0; $i < count($kategori); $i++) {
                    ...
                    <div class="d-flex align-items-stretch" style="min-height: 50px;">
                        <button id="kategoriListBtn"
                            class="d-flex d-lg-none align-items-center clean-btn btn-style-1">Kategori</button>
                        <button id="checkOutBtn"
                            class="w-100 clean-btn btn-style-2 btn-check-out icon-basket">&nbspCheck Out</button>
                    </div>
                </div>
