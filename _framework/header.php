<header>
    <div class="m-0 p-1 bg-light w-100 d-flex align-items-stretch flex-column flex-md-row justify-content-between" style="border-bottom: 2px black solid;"> 
        <button class="p-1 header-home-btn" id="homeBtn"><img class="img-fluid" src="administrator/img/logo/food4Ever_logo_colored_detail.svg" style="max-width: 150px; min-width:100px; width:auto"/></button>
    ...
    <div class="w-100 d-flex align-items-stretch d-lg-none flex-column">
        <button id="toggleMenuBtn" class="w-100 bg-brown-1 header-drop-btn"><span id="toggleIconHeader" class="icon-down-open ft-white-1"></span></button>
        <div id="menuContVer" class="bg-brown-2" style="display: none;">
            <ul class="header-list d-flex justify-content-end px-2 w-100 align-items-stretch flex-column ">
                <li>
                    <button class="p-2 ft-white-1 pesanMenuBtn">Pesan Menu</button>
                </li>
                <li>
                    <button class="p-2 ft-white-1 pesanTempatBtn">Pesan Tempat</button>
                </li>
                <li>
                    <button class="p-2 ft-white-1 aboutUsBtn">Tentang Kami</button>
                </li>
                <li>
                    <button class="p-2 ft-white-1 calllUsBtn">Hubungi Kami</button>
                </li>
                <li>
                    <button class="p-2 ft-white-1 d-flex align-items-center <?php
                        if(isset($_SESSION['userID'])){
                            echo'profilBtn';
                        }
                        else{
