...
<html class="notranslate" translate="no">
    <head>
        ...
        <title>Riwayat Pembelian | Database Food4Ever</title>
    </head>
    ...
    <body>
        ...
        <div class="mt-3 p-2">
            <div class="mt-4">
                <?php 
                    echo'<div class="py-2">';
                    $stmt = $db->prepare('SELECT * FROM purchase_history_tb a JOIN account_tb b ON a.acc_id=b.id');
                    $stmt->execute();
                        ...
                        for($i=0; $i<count($purHistory); $i++){
                            echo'   
                                <div class="d-flex py-2 flex-wrap align-items-stretch w-100 border-bottom">
                                    ...
                                    <a class="col-12 col-sm-3 d-flex justify-content-center align-items-center" href="receipt/makanan/'.$purHistory[$i]['filename'].'" download>Download</a>
                                </div>
                                ';
                        }
                    }
